...
namespace configurator.Helpers
{
    public static class PortParser
    {
        public static List<KeyValuePair<string, SerialPort>> GetPorts()
        {
            ...
            var serialQuery = new SelectQuery("SELECT * FROM Win32_PnPEntity WHERE ClassGuid=\"{4d36e978-e325-11ce-bfc1-08002be10318}\"");
        ...
        {
            return new KeyValuePair<string, SerialPort>(device, new SerialPort(comPort, 115200) {Handshake = Handshake.None});
        }
